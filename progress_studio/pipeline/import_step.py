...
class ImportStep:
    ...
    def execute(self, context: PipelineContext) -> PipelineContext:
        ...
        name, wbs_count, activity_count = self._service.import_xml(context.source_xml, output_file, weight_basis=context.weight_basis, amount_field=context.amount_field)
