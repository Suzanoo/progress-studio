...
def test_scurve_preview_is_removed_from_current_desktop_scope() -> None:
    app_source = (ROOT / "progress_studio/presentation/gui/app.py").read_text()
...
def test_no_hover_or_tooltip_rendering_added_to_mapping_ui() -> None:
    mapping_source = (ROOT / "progress_studio/presentation/gui/amount_mapping.py").read_text().lower()
